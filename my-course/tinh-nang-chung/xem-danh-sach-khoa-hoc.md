...
**Đường dẫn:** [LMS → My Course](https://lms-pro.sapp.edu.vn/courses)
{% endhint %}
...
<summary>Lọc Khóa học theo điều kiện cho trước</summary>
...
1. Màn hình **My Course** chỉ hiển thị các khóa học mà học viên **đã được đăng ký** trên hệ thống. Nếu không thấy khóa học mong muốn, học viên cần kiểm tra lại tình trạng đăng ký với phòng tư vấn của SAPP.
2. Thông tin **Thời hạn còn lại của Khóa học** sẽ hiển thị khác nhau theo loại khóa học:
   ...
   * **Khóa học thử:** có thể được **Extend** một lần khi hết hạn lần đầu tiên; sau lần thứ 2 cần liên hệ với đội ngũ hỗ trợ tại SAPP.
...
1. Khi có nhiều khóa học, sử dụng **bộ lọc theo Chương trình** (CFA / ACCA / CMA / L\&D) để nhanh chóng nhìn thấy các khóa cùng chương trình.
...
| ---------------------------------------------------------------- | ------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| Không thấy bất kỳ khóa học nào trong My Course                   | Tài khoản chưa được gán vào lớp / chưa hoàn tất đăng ký khóa học                | Liên hệ phòng tư vấn của SAPP để kiểm tra tình trạng đăng ký và gán lớp.                                              |
...
| Thông tin **Thời hạn còn lại** hiển thị "0 ngày" hoặc đã hết hạn | Khóa học đã hết thời hạn truy cập                                               | Với khóa học thử: click **Extend** để gia hạn lần đầu. Với khóa học khác: liên hệ đội ngũ hỗ trợ SAPP để được hỗ trợ. |
| Khóa học thử không có nút Extend khi hết hạn                     | Khóa học thử đã được Extend trước đó (chỉ được gia hạn tự động 1 lần)           | Liên hệ với đội ngũ hỗ trợ SAPP để được hỗ trợ tiếp tục gia hạn.                                                      |
